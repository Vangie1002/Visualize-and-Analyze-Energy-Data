...
### -- Step 1: Obtain & Preprocess Original Power Consump.Data -- ###
...
Data2 <- 
  ...
  rename(GAP_kW = Global_active_power,
         
         GRP_kW = Global_reactive_power,
...
Data3$GAP <- (Data3$GAP_kW * 1000/60)

Data3$GRP <- (Data3$GRP_kW * 1000/60)
