...
### ------ Step 2: Data Analysis and Visualization Part 1 ------- ###
...
sum(Cost2007Holiday$Totalkwh) # 103 kWh wasted energy!



# 23 Feb 2008 - 04 Mar 2008 Holiday Analysis
...
sum(Cost2008Holiday$Totalkwh) # 133 kWh wasted energy!
...
sum(Cost2008Holiday2$Totalkwh) # 113 kWh wasted energy!
...
sum(Cost2009Holiday$Totalkwh) # 161 kWh wasted energy!
...
sum(Cost2010Holiday$Totalkwh) # 161 kWh wasted energy
